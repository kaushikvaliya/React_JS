                    ...
                    <div className="signin-signup">
                        <form action="#" className="sign-in-form" >
                            ...
                            <div className="input-field">
                                ...
                                <input type="text" name="username" placeholder="Username" className='thisrequired' />


                            </div>
                            <div className="input-field">
                                <i className="fas fa-lock"></i>
                                <input type="password" name='Password' placeholder="Password" className='thisrequired' />
                            </div>
                        ...
                        <form action="#" className="sign-up-form">
                            ...
                            <div className="input-field">
                                ...
                                <input type="email" name='email' placeholder="Email" className='thisrequired' />
                                <span id='result'></span>
