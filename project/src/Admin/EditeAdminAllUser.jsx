...
//                             <div className="row mt-3">
//                                 <div className="col">
//                                     <input type="text" className='form-control' placeholder='Enter User password' value={inp.password} name="password" onChange={handleChange} id="username" />
//                                 </div>
//                             </div>
//                             <div className="row mt-3">
//                                 <div className="col">
//                                     <input type="text" className='form-control' placeholder='Enter User email' value={inp.email} name="email" onChange={handleChange} id="username" />
//                                 </div>
//                             </div>
//                             <div className="row mt-3">
//                                 <div className="col">
